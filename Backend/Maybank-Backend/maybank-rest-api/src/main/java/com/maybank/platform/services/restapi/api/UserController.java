...
public class UserController extends BaseController implements UserApi {
    ...
    public ResponseEntity<Map<String, Object>> getUserListing(@Valid @RequestBody UserListingRequest userListingRequest){
        ...
        try {
            ...
            if (ObjectUtils.isEmpty(userListingRequest.getDisplayName())) {
                userPage = userService.findAll(pagingSort);
            } else {
                userPage = userService.findByDisplayName(userListingRequest.getDisplayName(), pagingSort);
            }
